...
"data/svg+xml;charset=UTF-8," +
encodeURIComponent(`         <svg xmlns="http://www.w3.org/2000/svg" width="256" height="256">             <rect width="256" height="256" rx="128" fill="#5865f2"/>             <text x="50%" y="55%" text-anchor="middle"
                  font-family="Arial" font-size="110"
                  font-weight="700" fill="white">E</text>         </svg>
    `);
    ...
    profilePicture.addEventListener(
        ...
        async event => {
            ...
            try {
                ...
                alert(
                    "Could not load that profile picture. Please choose a smaller image."
                );
            }
        }
    );
